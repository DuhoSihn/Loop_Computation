...
% hold on
% boundary_f = zeros( size( likelihood_f ) );
% boundary_f( 2 : end - 1, 2 : end - 1 ) = ~isnan( likelihood_f( 2 : end - 1, 2 : end - 1 ) ) & ( isnan( likelihood_f( 1 : end - 2, 2 : end - 1 ) ) | isnan( likelihood_f( 3 : end, 2 : end - 1 ) ) | isnan( likelihood_f( 2 : end - 1, 1 : end - 2 ) ) | isnan( likelihood_f( 2 : end - 1, 3 : end ) ) );
...
%     for c2 = 1 : size( boundary_f, 2 )
%         if boundary_f( c1, c2 ) == 1
%             plot( 2 * ( 0.5 + 2 ) * pool_I( c2 ), spkT1( c1 ), '.k' )
%         end
%     end; clear c2
% end; clear c1
% colormap( gca, colors )
...
% imagesc( noiseLevel, [ 2 : 6 ], transpose( P_pool ) )
% hold on
% plot( noiseLevel, 3.5 * ones( 1, length( noiseLevel ) ), '.k' )
% set( gca, 'xtick', [ 0 : 1 : 4 ], 'xticklabel', { '0', '1/6', '2/6', '3/6', '4/6' } )
% colormap( colors )
% colorbar( 'ticks', [ 0, 1 ], 'ticklabels', { '', '' } )
% 
