function [ Z1, Z2, Z3, Z4, W1, W2, W3, W4 ] = assemblyComputation4( S1, S2, S3, S4, W1, W2, W3, W4, threshold, period_initiation, period_active, period_refractory, learning_rate )
...
for t = 1 : size( S1, 2 )
    ...
    if nargin == 9
        ...
        W4( X4 == 1, X1 == 1) = ( 1 + learning_rate ) * W4( X4 == 1, X1 == 1);
