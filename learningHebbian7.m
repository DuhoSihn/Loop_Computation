function [ W1, W2, W3, W4, W5, W6, W7 ] = learningHebbian7( S1, S2, S3, S4, S5, S6, S7 )
...
for t = 1 : size( S1, 2 )
    ...
    W6( S6( :, t ) == 1, S7( :, t ) == 1) = W6( S6( :, t ) == 1, S7( :, t ) == 1) + 1;
    W7( S7( :, t ) == 1, S1( :, t ) == 1) = W7( S7( :, t ) == 1, S1( :, t ) == 1) + 1;
end
