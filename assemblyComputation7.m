function [ Z1, Z2, Z3, Z4, Z5, Z6, Z7, W1, W2, W3, W4, W5, W6, W7 ] = assemblyComputation7( S1, S2, S3, S4, S5, S6, S7, W1, W2, W3, W4, W5, W6, W7, threshold, period_initiation, period_active, period_refractory, learning_rate )
...
if size( S6, 2 ) ~= size( S7, 2 ), error( 'Duration of S6 and S7 must be same!' ), end
...
for t = 1 : size( S1, 2 )
    ...
    if t == 1
        ...
        idx7 = count7( :, t - 1 ) >= 1 & count7( :, t - 1 ) < period_initiation + period_active + period_refractory;
        ...
        count7( idx6, t ) = count7( idx6, t - 1 ) + 1;
        ...
        idx7 = count7( :, t - 1 ) == period_initiation + period_active + period_refractory;
        count1( idx1, t ) = 0;
        count2( idx2, t ) = 0;
        count3( idx3, t ) = 0;
        count4( idx4, t ) = 0;
    ...
    idx7 = count7( :, t ) > period_initiation & count7( :, t ) <= period_initiation + period_active;
    Z1( idx1, t ) = 1;
    Z2( idx2, t ) = 1;
    Z3( idx3, t ) = 1;
    Z4( idx4, t ) = 1;
    ...
    if nargin == 9
        ...
        W6( X6 == 1, X7 == 1) = ( 1 + learning_rate ) * W6( X6 == 1, X7 == 1);
        W7( X7 == 1, X1 == 1) = ( 1 + learning_rate ) * W7( X7 == 1, X1 == 1);
